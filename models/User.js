...
User.create = user => {
  return db.one(`INSERT INTO users (email,name,company,icon,signature,accessToken,refreshToken) VALUES ($1,$2,$3,$4,$5,$6,$7) RETURNING *`,[user.email,user.name,user.company,user.icon,user.signature,user.accessToken,user.refreshToken])
}
