...
#Go to resume
alias resume='cd ~/desktop/resume'

#go to unit1
alias u1='cd ~/desktop/wdi_test/unit_01'

#go to unit2
alias u2='cd ~/desktop/wdi_test/unit_02'

#go to unit3
alias u3='cd ~/desktop/wdi_test/unit_03'

#go to unit4
alias u4='cd ~/desktop/wdi_test/unit_04'

#go to practiceApp
alias exp='cd ~/desktop/practice-express-app'

#go to DateTime
alias dt='cd ~/desktop/DateTime'

#go to portfolio
alias p='cd ~/desktop/react-portfolio/portfolio'
# =================
# Change System Settings
# =================
...
function getjq(){
  curl -f http://code.jquery.com/jquery-3.2.1.min.js > jquery.js
  if [ -s jquery.js ]
  then
